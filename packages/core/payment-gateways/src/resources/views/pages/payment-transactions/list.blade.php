            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.payment-transactions.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.payment-transactions.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.payment-transactions.export')
                                        <a href="{{ route('dashboard.payment-transactions.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.payment-transactions.import')
                                        <a href="{{ route('dashboard.payment-transactions.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.payment-transactions.create')
                                        <a href="{{ route('dashboard.payment-transactions.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="text" name="for" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("for")" value="{{ request("for") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="status"> @lang("status") </label>
                                            <input type="text" name="status" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("status")" value="{{ request("status") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                        <label for="request_data"> @lang("request data") </label>
                                        <input type="number" name="request_data" class="form-control filter-input"
                                            placeholder=""@lang("search for") @lang("request data") " value="{{ request("request_data") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="payment_method"> @lang("payment method") </label>
                                            <input type="text" name="payment_method" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("payment method")" value="{{ request("payment_method") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                        <label for="payment_data"> @lang("payment data") </label>
                                        <input type="number" name="payment_data" class="form-control filter-input"
                                            placeholder=""@lang("search for") @lang("payment data") " value="{{ request("payment_data") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                        <label for="payment_response"> @lang("payment response") </label>
                                        <input type="number" name="payment_response" class="form-control filter-input"
                                            placeholder=""@lang("search for") @lang("payment response") " value="{{ request("payment_response") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.payment-transactions.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="request_data">@lang("request data")</th>
                                    <th class="text-center p-0" data-name="payment_method">@lang("payment method")</th>
                                    <th class="text-center p-0" data-name="payment_data">@lang("payment data")</th>
                                    <th class="text-center p-0" data-name="payment_response">@lang("payment response")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.payment-transactions.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
