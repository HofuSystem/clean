...
use Core\Financials\Requests\OrderInvoicesRequest; 
use Core\Financials\Requests\ImportOrderInvoicesRequest; 
use Core\Financials\Exports\OrderInvoicesExport; 
use Core\Financials\Services\OrderInvoicesService;
...
class OrderInvoicesController extends Controller
{
    ...
    public function index(){
        ...
        return view('financials::pages.order-invoices.list', compact('title','screen','orders','users',"total","trash"));
    }
    ...
    public function createOrEdit(Request $request,$id = null){
        ...
        return view('financials::pages.order-invoices.edit', compact('item','title','screen','orders','users') );
    }
    ...
    public function show($id){
        ...
        return view('financials::pages.order-invoices.show', compact('title','screen','item','comments'));
    }
