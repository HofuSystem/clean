            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.purchases.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    @can('dashboard.purchases.export')
                                        <a href="{{ route('dashboard.purchases.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.purchases.import')
                                        <a href="{{ route('dashboard.purchases.import') }}"
                                            class="btn-operation">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <select class="custom-select filter-input form-select advance-select" name="item_id" id="item_id">
                                            ...
                                            @foreach($items as $iItem)
                                                <option value="{{ $iItem->id }}" @selected($iItem->id  == request("item_id")) >{{ $iItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.purchases.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center p-0" data-name="tax_value">@lang("tax value")</th>
                                <th class="text-center p-0" data-name="value_after_tax">@lang("value after tax")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.purchases.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
