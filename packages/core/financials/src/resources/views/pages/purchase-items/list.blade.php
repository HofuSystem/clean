            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.purchase-items.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.purchase-items.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    @can('dashboard.purchase-items.export')
                                        <a href="{{ route('dashboard.purchase-items.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.purchase-items.import')
                                        <a href="{{ route('dashboard.purchase-items.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    <a href="{{ route('dashboard.purchase-items.create') }}"
                                        class="btn-operation ">
                ...
                <div class="card-body pt-0 table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.purchase-items.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.purchase-items.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
