            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.purchase-providers.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.purchase-providers.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    @can('dashboard.purchase-providers.export')
                                        <a href="{{ route('dashboard.purchase-providers.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.purchase-providers.import')
                                        <a href="{{ route('dashboard.purchase-providers.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    <a href="{{ route('dashboard.purchase-providers.create') }}"
                                        class="btn-operation ">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        <label for="commercial_registration"> @lang("commercial registration") </label>
                                        <input type="text" name="commercial_registration" class="form-control filter-input"
                                            placeholder="@lang("search for commercial registration") " value="{{ request("commercial_registration") }}">
                                    </div>
                                    <div class="col-md-4 mb-1">
                                        <label for="tax_number"> @lang("tax number") </label>
                                        <input type="text" name="tax_number" class="form-control filter-input"
                                            placeholder="@lang("search for tax number") " value="{{ request("tax_number") }}">
                                    </div>
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <select class="custom-select filter-input form-select advance-select" name="city_id" id="city_id">
                                            ...
                                            @foreach($cities as $cItem)
                                                <option value="{{ $cItem->id }}" @selected($cItem->id  == request("city_id")) >{{ $cItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <select class="custom-select filter-input form-select advance-select" name="district_id" id="district_id">
                                            ...
                                            @foreach($districts as $dItem)
                                                <option value="{{ $dItem->id }}" @selected($dItem->id  == request("district_id")) >{{ $dItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                ...
                <div class="card-body pt-0 table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.purchase-providers.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center p-0" data-name="commercial_registration">@lang("commercial registration")</th>
                                <th class="text-center p-0" data-name="tax_number">@lang("tax number")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.purchase-providers.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
