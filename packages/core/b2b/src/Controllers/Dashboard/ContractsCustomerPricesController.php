...
use Core\B2B\Requests\ContractsCustomerPricesRequest; 
use Core\B2B\Requests\ImportContractsCustomerPricesRequest; 
use Core\B2B\Exports\ContractsCustomerPricesExport; 
use Core\B2B\Services\ContractsCustomerPricesService;
    ...
    public function storeOrUpdate(ContractsCustomerPricesRequest $request, $id = null){
        try {
            ...
            if(isset($request->extra_id)){
                $data['contract_id'] = $request->extra_id;
            }

            DB::beginTransaction();
            $record             = $this->contractsCustomerPricesService->storeOrUpdate($data,$id);
