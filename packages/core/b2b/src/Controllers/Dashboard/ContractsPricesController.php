...
use Core\B2B\Requests\ContractsPricesRequest; 
use Core\B2B\Requests\ImportContractsPricesRequest; 
use Core\B2B\Exports\ContractsPricesExport; 
use Core\B2B\Services\ContractsPricesService;
...
class ContractsPricesController extends Controller
{
    ...
    public function storeOrUpdate(ContractsPricesRequest $request, $id = null){
        try {
            ...
            DB::beginTransaction();
            $record             = $this->contractsPricesService->storeOrUpdate($data,$id);
