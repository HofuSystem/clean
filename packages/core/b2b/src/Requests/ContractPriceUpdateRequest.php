...
class ContractPriceUpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        return [
            'over_price.required' => trans('over_price_required'),
            'over_price.numeric' => trans('over_price_numeric'),
            'over_price.min' => trans('over_price_min'),
            'over_price.max' => trans('over_price_max', ['max' => $maxAllowed]),
        ];
    }
}
