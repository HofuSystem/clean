@php
    $navItems = [
        ...
        ['id' => 'invoices', 'route' => 'client.monthly-invoices', 'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'permission' => 'invoices-payments'],
        ['id' => 'overprices', 'route' => 'client.contracts.customer-prices', 'icon' => 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', 'permission' => 'edit-guest-pricing'],
