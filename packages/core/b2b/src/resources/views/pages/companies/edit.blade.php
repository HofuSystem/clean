...
@section('content')
            ...
            <div id="kt_content_container" class="container-fluid">
                <div class="card">
                    <div class="card-header border-0 pt-5">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold wizard-nav">
                            <li class="nav-item">
                                <a class="nav-link text-active-primary py-5 active" data-bs-toggle="tab" href="#kt_company_step_1">@lang('1- Company Data')</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary py-5 @if(!isset($item)) disabled @endif" data-bs-toggle="tab" href="#kt_company_step_2">@lang('2- Branches')</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary py-5 @if(!isset($item)) disabled @endif" data-bs-toggle="tab" href="#kt_company_step_3">@lang('3- Company Employees')</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary py-5 @if(!isset($item)) disabled @endif" data-bs-toggle="tab" href="#kt_company_step_4">@lang('4- Contract')</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary py-5 @if(!isset($contract)) disabled @endif" data-bs-toggle="tab" href="#kt_company_step_5">@lang('5- Product Prices')</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="kt_company_step_1" role="tabpanel">
                            <form class="form" method="POST" id="operation-form" data-id="{{ $item->id ?? null }}"
                                ...
                                @if(isset($item))
                                    action="{{ route('dashboard.companies.edit', $item->id) }}"
                                    data-mode="edit"
                                @else
                                    action="{{ route('dashboard.companies.create') }}"
                                    data-mode="new"
                                @endif>
                                @csrf
                                <div class="card-body row">
                                    <div class="form-group mb-3 col-md-12 text-center">
                                        ...
                                        <div class="media-center-group form-control" data-max="1" data-type="image">
                                            ...
                                            <button type="button" class="btn btn-secondary media-center-load" style="margin-top:10px;">
                                    ...
                                    <div class="form-group mb-3 col-md-3">
                                        ...
                                        <select class="custom-select form-select ajax-select" data-url="{{ route('dashboard.companies.search-users') }}" name="owner_id" id="owner_id">
                                            @if(isset($item) && $item->owner)
                                                <option value="{{ $item->owner->id }}" selected>{{ $item->owner->fullname }} : {{ $item->owner->phone }}</option>
                                            @else
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary font-weight-bold">
                                         @if(isset($item)) {{ trans('Update Company Data') }} @else {{ trans('Create Company & Continue') }} @endif
                                    </button>
                                    @if(isset($item))
                                        <button type="button" class="btn btn-light-primary font-weight-bold ms-2 next-step">@lang('Next') <i class="fas fa-arrow-right"></i></button>
                                    @endif
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tab-pane fade" id="kt_company_step_2" role="tabpanel">
                                        ...
                                        <table class="table table-striped table-hover text-center">
                                            <thead class="table-primary">
                                                <tr>
                                                    ...
                                                    <th scope="col" data-name="is_default" data-type="checkbox">{{ trans('default') }}</th>
                                                    <th scope="col" data-name="is_active" data-type="checkbox">{{ trans('active') }}</th>
                                                    <th scope="col" data-name="actions" data-type="actions">{{ trans('actions') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($item->branches ?? [] as $branch)
                                                    <tr data-id="{{ $branch->id }}" data-data="{{ json_encode($branch->itemData) }}">
                                                        <td>{{ $branch->name }}</td>
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                ...
                                <button type="button" class="btn btn-light-primary font-weight-bold next-step">@lang('Next') <i class="fas fa-arrow-right"></i></button>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            <tbody>
                                                @foreach($employees as $employee)
                                                    <tr data-id="{{ $employee->id }}" data-data="{{ json_encode($employee->itemData) }}">
                                                        <td data-name="user_id" data-type="select">{{ $employee->user?->fullname }}</td>
                                                        <td data-name="permission_id" data-type="select">{{ $employee->permission?->name }}</td>
                                ...
                                <form class="form" method="POST" id="contract-form" 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-3 col-md-3">
                                            ...
                                            <input type="number" name="months_count" class="form-control" value="{{ $contract->months_count ?? '' }}" required>
                                        </div>
                                        <div class="form-group mb-3 col-md-3">
                                            <label for="month_fees" class="required">{{ trans('month fees') }}</label>
                                            <input type="number" name="month_fees" class="form-control" value="{{ $contract->month_fees ?? '' }}" required>
                                        </div>
                                        <div class="form-group mb-3 col-md-3">
                                            <label for="start_date">{{ trans('start date') }}</label>
                                            <input type="date" name="start_date" class="form-control" value="{{ isset($contract->start_date) ? $contract->start_date->format('Y-m-d') : '' }}">
                                        </div>
                                        <div class="form-group mb-3 col-md-3">
                                            <label for="end_date">{{ trans('end date') }}</label>
                                            <input type="date" name="end_date" class="form-control" value="{{ isset($contract->end_date) ? $contract->end_date->format('Y-m-d') : '' }}">
                                        </div>
                                        <div class="form-group mb-3 col-md-3">
                                            <label for="commercial_registration">{{ trans('commercial registration') }}</label>
                                            <input type="text" name="commercial_registration" class="form-control" value="{{ $contract->commercial_registration ?? '' }}">
                                        </div>
                                        <div class="form-group mb-3 col-md-3">
                                            <label for="tax_number">{{ trans('tax number') }}</label>
                                            <input type="text" name="tax_number" class="form-control" value="{{ $contract->tax_number ?? '' }}">
                                        </div>
                        ...
                        <div class="tab-pane fade" id="kt_company_step_5" role="tabpanel">
                            <div class="card-body">
                                ...
                                <div class="items-container"
                                    ...
                                    data-items-name="contracts-prices"
                                            ...
                                            <tbody>
                                                @foreach($contract->contractPrices ?? [] as $cp)
                                                    <tr data-id="{{ $cp->id }}" data-data="{{ json_encode($cp->itemData) }}">
                                                        <td> {{ $cp->product?->category?->name }} ➡️ {{ $cp->product?->subCategory?->name }} ➡️ {{ $cp->product?->name }}</td>
                                                        <td>{{ $cp->price }}</td>
                        ...
                        <div class="tab-pane fade" id="kt_company_step_6" role="tabpanel">
                            <div class="card-body">
                                ...
                                <div class="items-container"
                                    data-items-on="contract_id"
                                    data-items-name="contracts-customer-prices"
                                            ...
                                            <tbody>
                                                @foreach($contract->contractCustomerPrices ?? [] as $ccp)
                                                    <tr data-id="{{ $ccp->id }}" data-data="{{ json_encode($ccp->itemData) }}">
                                                        <td>{{ $ccp->product?->category?->name }} ➡️ {{ $ccp->product?->subCategory?->name }} ➡️ {{ $ccp->product?->name }}</td>
    ...
    @if(isset($item))
    <!--– Branches Modal –-->
    <div class="modal fade" id="company-branchesModal" aria-hidden="true"
        aria-labelledby="company-branchesModalLabel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-md-12">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="is_default">{{ trans('is default') }}</label>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3 col-md-12">
                                        <div class="form-check form-switch">
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <div class="mb-2">
                                    <div class="input-group">
                                        <input type="text" id="branch_map_search" class="form-control" placeholder="@lang('Search for a location...')">
                                ...
                                <div id="branch_map" style="height: 360px; border: 1px solid #ccc; border-radius: 5px;"></div>
                                <p class="text-muted small mt-2">@lang('Click on the map or drag the marker to set location.')</p>
                            </div>
    ...
    <!--– Employees Modal –-->
    <div class="modal fade" id="company-employeesModal" aria-hidden="true"
        aria-labelledby="company-employeesModalLabel"
                    ...
                    <form class="modal-form items-modal-form">
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <select class="form-select ajax-select" data-url="{{ route('dashboard.companies.search-users') }}" name="user_id" id="employee_user_id" required>
    ...
    <div class="modal fade" id="contracts-pricesModal" aria-hidden="true"
        aria-labelledby="contracts-pricesModalLabel"
                            ...
                            <div class="form-group mb-3 col-md-12">
                                ...
                                <select class="form-select advance-select" name="product_id" required>
                                    ...
                                    @foreach($products ?? [] as $p)
                                        <option value="{{ $p->id }}">{{ $p->category?->name }} ➡️ {{ $p->subCategory?->name }} ➡️ {{ $p->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group mb-3 col-md-12">
    ...
    <div class="modal fade" id="contracts-customer-pricesModal" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="contracts-customer-pricesModalLabel">{{ trans('Customer Over Prices') }}</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="modal-form items-modal-form">
    ...
    <div class="modal fade" id="company-branchesDeleteModel" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog"><div class="modal-content text-center"><div class="modal-body"><button type="button" class="btn-close mb-5" data-bs-dismiss="modal"></button><h1 class="mb-3">@lang('Are you sure?')</h1><p>@lang('You want to delete this branch?')</p><button type="button" class="btn btn-danger items-final-delete">@lang('Delete')</button></div></div></div>
    </div>
    <div class="modal fade" id="company-employeesDeleteModel" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog"><div class="modal-content text-center"><div class="modal-body"><button type="button" class="btn-close mb-5" data-bs-dismiss="modal"></button><h1 class="mb-3">@lang('Are you sure?')</h1><p>@lang('You want to remove this employee?')</p><button type="button" class="btn btn-danger items-final-delete">@lang('Remove')</button></div></div></div>
    </div>
    <div class="modal fade" id="contracts-pricesDeleteModel" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog"><div class="modal-content text-center"><div class="modal-body"><button type="button" class="btn-close mb-5" data-bs-dismiss="modal"></button><h1 class="mb-3">@lang('Are you sure?')</h1><p>@lang('You want to delete this price?')</p><button type="button" class="btn btn-danger items-final-delete">@lang('Delete')</button></div></div></div>
    </div>
