            ...
            <div class="card">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex">
                                    ...
                                    <div class="border border-dashed border-danger text-danger rounded mx-1 p-2">
                                        <a href="{{ route('dashboard.companies.index', ['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    @can('dashboard.companies.create')
                                        <a href="{{ route('dashboard.companies.create') }}" class="btn-operation">
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                    <div class="col-6 mb-1">
                                        ...
                                        <input type="text" name="fullname" class="form-control filter-input"
                                            placeholder="@lang('search for') @lang('fullname')" value="{{ request('fullname') }}">
                                    </div>
                                    <div class="col-6 mb-1">
                                        <label for="email">@lang('email')</label>
                                        <input type="text" name="email" class="form-control filter-input"
                                            placeholder="@lang('search for') @lang('email')" value="{{ request('email') }}">
                                    </div>
                                    <div class="col-6 mb-1">
                                        <label for="phone">@lang('phone')</label>
                                        <input type="text" name="phone" class="form-control filter-input"
                                            placeholder="@lang('search for') @lang('phone')" value="{{ request('phone') }}">
                                    </div>
                                    <div class="col-6 mb-1">
                                        <label for="from_created_at">@lang('Create Date from')</label>
                                        <input type="datetime-local" name="from_created_at" class="form-control filter-input">
                                    </div>
                                    <div class="col-6 mb-1">
                                        <label for="to_created_at">@lang('Create Date to')</label>
                ...
                <div class="card-body pt-0 table-responsive">
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.companies.index', ['trash' => request()->trash]) }}">
                        <thead class="table-primary">
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center p-0" data-name="fullname">@lang('fullname')</th>
                                <th class="text-center p-0" data-name="email">@lang('email')</th>
                                <th class="text-center p-0" data-name="phone">@lang('phone')</th>
                                <th class="text-center p-0" data-name="owner">@lang('owner')</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.companies.delete', ['id' => '%s', 'trash' => request()->trash]) }}"
</script>
@endpush
