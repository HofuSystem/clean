            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.contracts.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.contracts.export')
                                        <a href="{{ route('dashboard.contracts.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.contracts.import')
                                        <a href="{{ route('dashboard.contracts.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    @can('dashboard.contracts.qr-codes.form')
                                    <a href="{{ route('dashboard.contracts.qr-codes.form') }}"
                                        class="btn-operation">
                                        <i class="fas fa-qrcode"></i>
                                        <span>
                                            @lang('Create QR Codes')
                                        </span>
                                    </a>
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.contracts.create')
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="text" name="title" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("title")" value="{{ request("title") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="months_count"> @lang("months count") </label>
                                            <input type="number" name="months_count" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("months count")" value="{{ request("months_count") }}">
                                        </div>
                                         ...
                                         <div class="col-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="company_id" id="company_id">
                                                ...
                                                @foreach($companies ?? [] as $sItem)
                                                    <option value="{{ $sItem->id }}" @selected(request("company_id") == $sItem->id)>{{ $sItem->fullname }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        
                                        <div class="col-6 mb-1">
                                            <label for="month_fees"> @lang("month fees") </label>
                                            <input type="number" name="month_fees" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("month fees")" value="{{ request("month_fees") }}">
                                        </div>
                                        
                                        <div class="col-6 mb-1">
                                            <label for="unlimited_days">@lang("unlimited days")</label>
                                            <select class="custom-select filter-input form-select" name="unlimited_days" id="unlimited_days">
                                                <option value="">@lang("select")</option>
                                                <option value="0" @selected(request("unlimited_days") === "0")>@lang("No")</option>
                                                <option value="1" @selected(request("unlimited_days") === "1")>@lang("Yes")</option>
                                            </select>
                                        </div>
                                        
                                        <div class="col-6 mb-1">
                                            <label for="number_of_days"> @lang("number of days") </label>
                                            <input type="number" name="number_of_days" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("number of days")" value="{{ request("number_of_days") }}">
                                        </div>
                                        
                                        <div class="col-6 mb-1">
                                        <label for="start_date"> @lang("start date from") </label>
                                        <input type="date" name="from_start_date" class="form-control filter-input"
                                            placeholder="@lang("search for start date") " value="{{ request("start_date") }}">
                                            </div>
                                            <div class="col-6 mb-1">
                                            <label for="start_date"> @lang("start date to") </label>
                                            <input type="date" name="to_start_date" class="form-control filter-input"
                                                placeholder="@lang("search for start date") " value="{{ request("start_date") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                        <label for="end_date"> @lang("end date from") </label>
                                        <input type="date" name="from_end_date" class="form-control filter-input"
                                            placeholder="@lang("search for end date") " value="{{ request("end_date") }}">
                                            </div>
                                            <div class="col-6 mb-1">
                                            <label for="end_date"> @lang("end date to") </label>
                                            <input type="date" name="to_end_date" class="form-control filter-input"
                                                placeholder="@lang("search for end date") " value="{{ request("end_date") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.contracts.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="months_count">@lang("months count")</th>
                                    <th class="text-center p-0" data-name="month_fees">@lang("month fees")</th>
                                    <th class="text-center p-0" data-name="unlimited_days">@lang("unlimited days")</th>
                                    <th class="text-center p-0" data-name="number_of_days">@lang("number of days")</th>
                                    <th class="text-center p-0" data-name="contract">@lang("contract")</th>
                                    <th class="text-center p-0" data-name="start_date">@lang("start date")</th>
                                    <th class="text-center p-0" data-name="end_date">@lang("end date")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.contracts.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
