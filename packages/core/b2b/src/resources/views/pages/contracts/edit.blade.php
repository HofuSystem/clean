                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form" data-id="{{$item->id ?? null}}"
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label class="" for="company_id">{{ trans("company") }}</label>
                                <select class="custom-select  form-select advance-select" name="company_id" id="company_id"  >
                                     ...
                                     @foreach($companies ?? [] as $sItem)
                                         <option data-id="{{$sItem->id }}" @selected(isset($item)  and $item->company_id == $sItem->id) value="{{$sItem->id }}" >{{$sItem->fullname}}</option>
                                     @endforeach
                                </select>
                            </div>
