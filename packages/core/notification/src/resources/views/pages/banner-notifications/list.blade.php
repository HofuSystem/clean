            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.banner-notifications.index') }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.banner-notifications.export')
                                        <a href="{{ route('dashboard.banner-notifications.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.banner-notifications.import')
                                        <a href="{{ route('dashboard.banner-notifications.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.banner-notifications.create')
                                        <a href="{{ route('dashboard.banner-notifications.create') }}"
                                            class="btn-operation ">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <label for="publish_date"> @lang("publish date from") </label>
                                        <input type="date" name="from_publish_date" class="form-control filter-input"
                                            placeholder="@lang("search for publish date") " value="{{ request("publish_date") }}">
                                            </div>
                                            <div class="col-md-6 mb-1">
                                            <label for="publish_date"> @lang("publish date to") </label>
                                            <input type="date" name="to_publish_date" class="form-control filter-input"
                                                placeholder="@lang("search for publish date") " value="{{ request("publish_date") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                        <label for="expired_date"> @lang("expired date from") </label>
                                        <input type="date" name="from_expired_date" class="form-control filter-input"
                                            placeholder="@lang("search for expired date") " value="{{ request("expired_date") }}">
                                            </div>
                                            <div class="col-md-6 mb-1">
                                            <label for="expired_date"> @lang("expired date to") </label>
                                            <input type="date" name="to_expired_date" class="form-control filter-input"
                                                placeholder="@lang("search for expired date") " value="{{ request("expired_date") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="next_vision_hour"> @lang("next vision hour") </label>
                                            <input type="number" name="next_vision_hour" class="form-control filter-input"
                                                placeholder="@lang("search for next vision hour") " value="{{ request("next_vision_hour") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.banner-notifications.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="publish_date">@lang("publish date")</th>
                                    <th class="text-center p-0" data-name="expired_date">@lang("expired date")</th>
                                    <th class="text-center p-0" data-name="next_vision_hour">@lang("next vision hour")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.banner-notifications.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
