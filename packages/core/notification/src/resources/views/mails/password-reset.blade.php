                            ...
                            <tr>
                                <td class="header"
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" href="http://localhost"
                                        ...
                                        <img src="https://laravel.com/img/notification-logo.jpg" class="logo"
                                            alt="Laravel Logo"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <table class="subcopy" role="presentation"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        into your web browser: <span class="break-all"
                                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                                ...
                                                                                rel="noopener noreferrer"
                                                                                href="{{ $msg }}"
                                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ $msg }}</a></span>
                                                                    </p>
