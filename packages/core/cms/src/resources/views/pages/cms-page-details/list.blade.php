            ...
            <div class="card">
                        ...
                        <div data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.cms-page-details.index', $slug) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.cms-page-details.export')
                                        <a href="{{ route('dashboard.cms-page-details.export', $slug) }}" id="export"
                                    ...
                                    @endcan
                                    @can('dashboard.cms-page-details.import')
                                        <a href="{{ route('dashboard.cms-page-details.import', $slug) }}" class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.cms-page-details.create')
                                        <a href="{{ route('dashboard.cms-page-details.create', $slug) }}" class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <input type="number" name="description" class="form-control filter-input"
                                            placeholder="@lang('search for description') " value="{{ request('description') }}">
                                    </div>
                                    <div class="col-md-6 mb-1">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <input type="number" name="point" class="form-control filter-input"
                                            placeholder="@lang('search for point') " value="{{ request('point') }}">
                                    </div>
                                    <div class="col-md-6 mb-1">
                                        <label for="video"> @lang('video') </label>
                                        <input type="text" name="video" class="form-control filter-input"
                                            placeholder="@lang('search for video') " value="{{ request('video') }}">
                                    </div>
                                    <div class="col-md-6 mb-1">
                                        <label for="link"> @lang('link') </label>
                                        <input type="text" name="link" class="form-control filter-input"
                                            placeholder="@lang('search for link') " value="{{ request('link') }}">
                                    </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.cms-page-details.index', ['slug' => $slug, 'trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                @if ($pageData->have_intro)
                                    <th class="text-center p-0" data-name="intro">@lang('intro')</th>
                                @endif
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.cms-page-details.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
