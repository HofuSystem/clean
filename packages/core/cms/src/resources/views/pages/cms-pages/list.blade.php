                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.cms-pages.export')
                                        <a href="{{ route('dashboard.cms-pages.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.cms-pages.import')
                                        <a href="{{ route('dashboard.cms-pages.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.cms-pages.create')
                                    <a href="{{ route('dashboard.cms-pages.create',$slug) }}"
                                    class="btn-operation ">
               ...
               {{--  <div class="container-fluid mt-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.cms-pages.index',['trash' => request()->trash]) }}">
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.cms-pages.delete', ['id'=>'%s','trash'=>request()->trash]) }}"   
</script>
@endpush
