...
class GiftsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "translations.en.btn_text"    => ['nullable', 'string'],
            "translations.ar.btn_text"    => ['nullable', 'string'],
            "translations.en.label"       => ['nullable', 'string'],
            "translations.ar.label"       => ['nullable', 'string'],
            ...
            "order_type.*"                => ['in:clothes,sales,services,maid,host'],
