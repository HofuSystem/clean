            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.coupons.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.coupons.export')
                                        <a href="{{ route('dashboard.coupons.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.coupons.import')
                                        <a href="{{ route('dashboard.coupons.import') }}"
                                            class="btn-operation">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="text" name="code" class="form-control filter-input"
                                                placeholder="@lang("search for code") " value="{{ request("code") }}">
                                        </div>
                                      
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="payment_method">@lang("payment method")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="payment_method" id="payment_method">
                                                <option value=""> @lang("select payment_method")</option><option value="cash" @selected("cash" == request("payment_method")) >{{trans("cash")}}</option><option value="card" @selected("card" == request("payment_method")) >{{trans("card")}}</option>
                                            </select>
                                        </div>
                                    
                                        <div class="col-md-6 mb-1">
                                        <label for="start_at"> @lang("start at from") </label>
                                        <input type="date" name="from_start_at" class="form-control filter-input"
                                            placeholder="@lang("search for start at") " value="{{ request("start_at") }}">
                                            </div>
                                            <div class="col-md-6 mb-1">
                                            <label for="start_at"> @lang("start at to") </label>
                                            <input type="date" name="to_start_at" class="form-control filter-input"
                                                placeholder="@lang("search for start at") " value="{{ request("start_at") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                        <label for="end_at"> @lang("end at from") </label>
                                        <input type="date" name="from_end_at" class="form-control filter-input"
                                            placeholder="@lang("search for end at") " value="{{ request("end_at") }}">
                                            </div>
                                            <div class="col-md-6 mb-1">
                                            <label for="end_at"> @lang("end at to") </label>
                                            <input type="date" name="to_end_at" class="form-control filter-input"
                                                placeholder="@lang("search for end at") " value="{{ request("end_at") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.coupons.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="applying">@lang("applying")</th>
                                    <th class="text-center p-0" data-name="code">@lang("code")</th>
                                    <th class="text-center p-0" data-name="start_at">@lang("start at")</th>
                                    <th class="text-center p-0" data-name="end_at">@lang("end at")</th>
                                    <th class="text-center p-0" data-name="type">@lang("type")</th>
                                    <th class="text-center p-0" data-name="value">@lang("value")</th>
                                    <th class="text-center p-0" data-name="max_value">@lang("max value")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.coupons.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
