            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.districts.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.districts.map-points')
                                        <a href="{{ route('dashboard.districts.map-points') }}"  type="button"
                                            class="btn-operation ">
                                            <i class="fas fa-map-marker-alt"></i>
                                            <span>
                                                @lang('show map points')
                                            </span>
                                        </a>
                                    @endcan

                                    @can('dashboard.districts.export')
                                        <a href="{{ route('dashboard.districts.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.districts.import')
                                        <a href="{{ route('dashboard.districts.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.districts.create')
                                        <a href="{{ route('dashboard.districts.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="number" name="lat" class="form-control filter-input"
                                                placeholder="@lang("search for lat") " value="{{ request("lat") }}">
                                        </div>
                                        
                                        <div class="col-6 mb-1">
                                            <label for="lng"> @lang("lng") </label>
                                            <input type="number" name="lng" class="form-control filter-input"
                                                placeholder="@lang("search for lng") " value="{{ request("lng") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.districts.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.districts.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
