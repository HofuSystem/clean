            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.countries.export')
                                        <a href="{{ route('dashboard.countries.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.countries.import')
                                        <a href="{{ route('dashboard.countries.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.countries.create')
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="phonecode"> @lang("phonecode") </label>
                                            <input type="text" name="phonecode" class="form-control filter-input"
                                                placeholder="@lang("search for phonecode") " value="{{ request("phonecode") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="short_name"> @lang("short name") </label>
                                            <input type="text" name="short_name" class="form-control filter-input"
                                                placeholder="@lang("search for short name") " value="{{ request("short_name") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="flag"> @lang("flag") </label>
                                            <input type="text" name="flag" class="form-control filter-input"
                                                placeholder="@lang("search for flag") " value="{{ request("flag") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.countries.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="phonecode">@lang("phonecode")</th>
                                    <th class="text-center p-0" data-name="short_name">@lang("short name")</th>
                                    <th class="text-center p-0" data-name="flag">@lang("flag")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.countries.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
