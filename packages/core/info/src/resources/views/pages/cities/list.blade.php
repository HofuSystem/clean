            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.cities.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.cities.export')
                                        <a href="{{ route('dashboard.cities.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.cities.import')
                                        <a href="{{ route('dashboard.cities.import') }}"
                                            class="btn-operation">
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="text" name="slug" class="form-control filter-input"
                                                placeholder="@lang("search for slug") " value="{{ request("slug") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="text" name="postal_code" class="form-control filter-input"
                                                placeholder="@lang("search for postal code") " value="{{ request("postal_code") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="delivery_price"> @lang("delivery price") </label>
                                            <input type="number" name="delivery_price" class="form-control filter-input"
                                                placeholder="@lang("search for delivery price") " value="{{ request("delivery_price") }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="country_id" id="country_id">
                                                
                                                <option  value="" > @lang("select countries")</option>
                                                @foreach($countries as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("country_id")) >@lang($item->name)</option>
                                                @endforeach
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.cities.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="country_id">@lang("country")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.cities.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
