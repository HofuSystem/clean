            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            ...
                                            <div class="fw-bold fs-4">@lang('total')</div>
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            ...
                                            <div class="fw-bold fs-4">@lang('Trash')</div>
                                        </div>
                                        <!--end::Stat-->
                                    </div>
                                </div>
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.map-points.export')
                                        <a href="{{ route('dashboard.map-points.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.map-points.import')
                                        <a href="{{ route('dashboard.map-points.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.map-points.create')
                                        <a href="{{ route('dashboard.map-points.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="text" name="lat" class="form-control filter-input"
                                                placeholder="@lang("search for lat") " value="{{ request("lat") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="lng"> @lang("lng") </label>
                                            <input type="text" name="lng" class="form-control filter-input"
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.map-points.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.map-points.delete', '%s') }}"
</script>
@endpush
