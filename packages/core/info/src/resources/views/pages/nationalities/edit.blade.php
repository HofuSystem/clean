        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.nationalities.index")}}" data-id="{{$item->id ?? null}}"
                        @isset($item)
                            action="{{ route("dashboard.nationalities.edit",$item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route("dashboard.nationalities.create") }}"
                            data-mode="new"
                        @endisset
                        >
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label class="" for="arranging">{{ trans("arranging") }}</label>
                                <input type="number" name="arranging" class="form-control "
                                    placeholder="{{ trans("Enter arranging") }} " value="{{ old("arranging" , $item->arranging ?? null) }}">
