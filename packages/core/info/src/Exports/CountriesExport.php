...
class CountriesExport implements FromCollection, WithHeadings, WithMapping, WithCustomCsvSettings
{
    ...
    public function headings(): array
    {
        ...
        if(empty($this->cols) or in_array('phonecode',$this->cols)){
            $headings[] = trans('phonecode');
        }
        if(empty($this->cols) or in_array('short_name',$this->cols)){
            $headings[] = trans('short name');
        }
        if(empty($this->cols) or in_array('flag',$this->cols)){
            $headings[] = trans('flag');
        }             
        return $headings;
    }
