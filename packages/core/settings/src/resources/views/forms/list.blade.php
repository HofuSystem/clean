        ...
        <div class="content-wrapper container-fluidp-0">
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">@lang('forms')
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <div class="row">
                        <div class="col">
                            @can('dashboard.forms.create')
                            <h3 class="card-title"> <a href="{{ route('dashboard.forms.create') }}"
                                    ...
                                    <table class="table table-hover text-nowrap text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Auth</th>
                                                <th>Roles</th>
                                                @canany(['dashboard.forms.edit','dashboard.forms.destroy'])
                                                <th>Action</th>
                                                @endcan
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($forms as $form)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($form->auth)
                                                        <span class="badge bg-success">@lang('Requied')</span>
                                                        @else
                                                        <span class="badge bg-danger">@lang('Not Requied')</span>
                                                        @endif
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dashboard.forms.view',$form->slug ) }}"
                                                            class="btn btn-outline-success">View</a>
                                                            <a href="{{ route('dashboard.forms.show',$form->slug ) }}"
                                                                class="btn btn-outline-primary">Submmtions</a>
                                                        <a href="{{ route('dashboard.forms.edit', $form->slug) }}"
                                                            class="btn btn-outline-success">Edit</a>

                                                        <a href="{{ route('dashboard.forms.destroy', $form->id) }}"
