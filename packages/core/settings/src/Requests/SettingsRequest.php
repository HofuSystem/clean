...
class SettingsRequest extends FormRequest
{
	...
	public function rules()
	{
		return [
			...
			"clothes_allowed_payment_methods" => ['required', 'array'],
			"clothes_allowed_payment_methods.*" => ['required', 'string', 'in:cash,card,points,wallet'],
			"maid_allowed_payment_methods" => ['required', 'array'],
			"maid_allowed_payment_methods.*" => ['required', 'string', 'in:cash,card,points,wallet'],
			"services_allowed_payment_methods" => ['required', 'array'],
			"services_allowed_payment_methods.*" => ['required', 'string', 'in:cash,card,points,wallet'],
			"sales_allowed_payment_methods" => ['required', 'array'],
			"sales_allowed_payment_methods.*" => ['required', 'string', 'in:cash,card,points,wallet'],
			"coverage_paused_title_ar" => ['nullable', 'string'],
			"coverage_paused_title_en" => ['nullable', 'string'],
			"coverage_paused_message_ar" => ['nullable', 'string'],
			"coverage_paused_message_en" => ['nullable', 'string'],
			"coverage_paused_button_ar" => ['nullable', 'string'],
			"coverage_paused_button_en" => ['nullable', 'string'],
			"coverage_not_reached_title_ar" => ['nullable', 'string'],
			"coverage_not_reached_title_en" => ['nullable', 'string'],
			"coverage_not_reached_message_ar" => ['nullable', 'string'],
			"coverage_not_reached_message_en" => ['nullable', 'string'],
			"coverage_not_reached_button_ar" => ['nullable', 'string'],
			"coverage_not_reached_button_en" => ['nullable', 'string'],
