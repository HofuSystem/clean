            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.workers.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.workers.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.workers.export')
                                        <a href="{{ route('dashboard.workers.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.workers.import')
                                        <a href="{{ route('dashboard.workers.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.workers.create')
                                        <a href="{{ route('dashboard.workers.create') }}"
                                            class="btn-operation ">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="years_experience"> @lang("years experience") </label>
                                            <input type="number" name="years_experience" class="form-control filter-input"
                                                placeholder="@lang("search for years experience") " value="{{ request("years_experience") }}">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="nationality_id">@lang("nationality")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="nationality_id" id="nationality_id">
                                                
                                                <option  value="" > @lang("select nationalities")</option>
                                                @foreach($nationalities as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("nationality_id")) >@lang($item->name)</option>
                                                @endforeach
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.workers.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="years_experience">@lang("years experience")</th>
                                    <th class="text-center p-0" data-name="address">@lang("address")</th>
                                    <th class="text-center p-0" data-name="birth_date">@lang("birth date")</th>
                                    <th class="text-center p-0" data-name="hour_price">@lang("hour price")</th>
                                    <th class="text-center p-0" data-name="gender">@lang("gender")</th>
                                    <th class="text-center p-0" data-name="status">@lang("status")</th>
                                    <th class="text-center p-0" data-name="identity">@lang("identity")</th>
                                    <th class="text-center p-0" data-name="nationality_id">@lang("nationality")</th>
                                    <th class="text-center p-0" data-name="city_id">@lang("city")</th>
                                    <th class="text-center p-0" data-name="categories">@lang("categories")</th>
                                    <th class="text-center p-0" data-name="leader_id">@lang("leader_id")</th>
                                    <th class="text-center p-0" data-name="workdays">@lang("work days")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.workers.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
