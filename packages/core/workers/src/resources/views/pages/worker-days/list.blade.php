            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.worker-days.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.worker-days.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.worker-days.export')
                                        <a href="{{ route('dashboard.worker-days.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.worker-days.import')
                                        <a href="{{ route('dashboard.worker-days.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.worker-days.create')
                                        <a href="{{ route('dashboard.worker-days.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="worker_id">@lang("worker")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="worker_id" id="worker_id">
                                                
                                                <option  value="" > @lang("select workers")</option>
                                                @foreach($workers as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("worker_id")) >@lang($item->name)</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="type" id="type">
                                                <option value=""> @lang("select type")</option><option value="absence" @selected("absence" == request("type")) >{{trans("absence")}}</option><option value="attendees" @selected("attendees" == request("type")) >{{trans("attendees")}}</option>
                                            </select>
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.worker-days.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="worker_id">@lang("worker")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.worker-days.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
