    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="form-group mb-3 col-md-6">
                <label>{{ trans("device token") }}</label><p>{{ $item->device_token ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-12">
                ...
                <div class="card-footer">
                    <a href="{{ route('dashboard.devices.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> {{ trans('Back') }}</a>
                </div>
            </div>
        

                    @include('comment::inc.comment-section',['commentUrl'=>route('dashboard.devices.comment',$item->id)])
                </div>
                <!--end::Card-->
            </div>
            <!--end::Container-->
