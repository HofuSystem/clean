            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.devices.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.devices.export')
                                        <a href="{{ route('dashboard.devices.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.devices.import')
                                        <a href="{{ route('dashboard.devices.import') }}"
                                            class="btn-operation">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="device_token"> @lang("device token") </label>
                                            <input type="text" name="device_token" class="form-control filter-input"
                                                placeholder="@lang("search for device token") " value="{{ request("device_token") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="type">@lang("type")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="type" id="type">
                                                <option value=""> @lang("select type")</option><option value="ios" @selected("ios" == request("type")) >{{trans("ios")}}</option><option value="android" @selected("android" == request("type")) >{{trans("android")}}</option><option value="huawei" @selected("huawei" == request("type")) >{{trans("huawei")}}</option>
                                            </select>
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.devices.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="device_token">@lang("device token")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.devices.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
