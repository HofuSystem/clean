            ...
            <div class="card">
                        ...
                        <div data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.roles.index', ['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.roles.export')
                                        <a href="{{ route('dashboard.roles.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.roles.import')
                                        <a href="{{ route('dashboard.roles.import') }}" class="btn-operation">
                                    ...
                                    @can('dashboard.roles.create')
                                        <a href="{{ route('dashboard.roles.create') }}" class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        <label for="title"> @lang('role title') </label>
                                        <input type="text" name="title" class="form-control filter-input"
                                            placeholder="@lang('search for title') " value="{{ request('role title') }}">
                                    </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.roles.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center p-0" data-name="title">@lang('role title')</th>
...
@push('js')
    <script>
        var deleteUrl = "{{ route('dashboard.roles.delete', '%s', request()->all()) }}"
    </script>
@endpush
