            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.favs.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.favs.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.favs.export')
                                        <a href="{{ route('dashboard.favs.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.favs.import')
                                        <a href="{{ route('dashboard.favs.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.favs.create')
                                        <a href="{{ route('dashboard.favs.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="favs_type"> @lang("favs type") </label>
                                            <input type="text" name="favs_type" class="form-control filter-input"
                                                placeholder="@lang("search for favs type") " value="{{ request("favs_type") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="favs_id"> @lang("favs") </label>
                                            <input type="text" name="favs_id" class="form-control filter-input"
                                                placeholder="@lang("search for favs") " value="{{ request("favs_id") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.favs.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="favs_type">@lang("favs type")</th>
                                    <th class="text-center p-0" data-name="favs_id">@lang("favs")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.favs.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
