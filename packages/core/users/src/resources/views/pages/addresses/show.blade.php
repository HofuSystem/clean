    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="form-group mb-3 col-md-6">
                ...
                @isset($item->district)
                    <div class="alert alert-primary m-1" role="alert"><a href="{{ route('dashboard.districts.show',$item->district->id) }}">{{ $item?->district?->name ?? 'N/A' }}</a></div>
                @endisset

            </div>

            <div class="form-group mb-3 col-md-6">
                <label>{{ trans("is_default") }}</label><p>{{ $item->is_default ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-12">
                ...
                <div class="card-footer">
                    <a href="{{ route('dashboard.addresses.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> {{ trans('Back') }}</a>
                </div>
            </div>


                    @include('comment::inc.comment-section',['commentUrl'=>route('dashboard.addresses.comment',$item->id)])
                </div>
                <!--end::Card-->
            </div>
            <!--end::Container-->
