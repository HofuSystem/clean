            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.addresses.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    @can('dashboard.addresses.export')
                                    <a href="{{ route('dashboard.addresses.export') }}" id="export" type="button"
                                        class="btn-operation ">
                                ...
                                @endcan
                                @can('dashboard.addresses.import')
                                    <a href="{{ route('dashboard.addresses.import') }}"
                                        class="btn-operation">
                                ...
                                @endcan
                                <!--begin::Add -->
                                @can('dashboard.addresses.create')
                                    <a href="{{ route('dashboard.addresses.create',['forCompany' => $forCompany ?? false ]) }}"
                                        class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="text" name="is_default" class="form-control filter-input"
                                                placeholder="@lang("search for is_default") " value="{{ request("is_default") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.addresses.index',['trash' => request()->trash, 'forCompany' => $forCompany ?? false ]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.addresses.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
