            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.contracts-prices.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.contracts-prices.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.contracts-prices.export')
                                        <a href="{{ route('dashboard.contracts-prices.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.contracts-prices.import')
                                        <a href="{{ route('dashboard.contracts-prices.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.contracts-prices.create')
                                        <a href="{{ route('dashboard.contracts-prices.create') }}"
                                            class="btn-operation ">
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="number" name="price" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("price")" value="{{ request("price") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.contracts-prices.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.contracts-prices.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
