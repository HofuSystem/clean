            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.profiles.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.profiles.export')
                                        <a href="{{ route('dashboard.profiles.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.profiles.import')
                                        <a href="{{ route('dashboard.profiles.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.profiles.create')
                                        <a href="{{ route('dashboard.profiles.create') }}"
                                            class="btn-operation ">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="other_city_name"> @lang("other city name") </label>
                                            <input type="text" name="other_city_name" class="form-control filter-input"
                                                placeholder="@lang("search for other city name") " value="{{ request("other_city_name") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.profiles.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="district_id">@lang("district")</th>
                                    <th class="text-center p-0" data-name="other_city_name">@lang("other city name")</th>
                                    <th class="text-center p-0" data-name="user_id">@lang("user")</th>
                                    <th class="text-center p-0" data-name="bio">@lang("bio")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.profiles.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
