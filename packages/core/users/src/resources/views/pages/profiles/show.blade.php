            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card show-page">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                @isset($item->country)
                                    <div class="alert alert-primary m-1" role="alert"><a
                                            href="{{ route('dashboard.countries.show', $item->country->id) }}">{{ $item?->country?->name ?? 'N/A' }}</a>
                                    </div>
                                @endisset
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                @isset($item->district)
                                    <div class="alert alert-primary m-1" role="alert"><a
                                            href="{{ route('dashboard.districts.show', $item->district->id) }}">{{ $item?->district?->name ?? 'N/A' }}</a>
                                    </div>
                                @endisset
                            ...
                            <div class="form-group mb-3 col-md-12">
                                ...
                                @isset($item->user)
                                    <div class="alert alert-primary m-1" role="alert"><a
                                            href="{{ route('dashboard.users.show', $item->user->id) }}">{{ $item?->user?->fullname ?? 'N/A' }}</a>
                                    </div>
                                @endisset
                        ...
                        <div class="card-footer">
                            <a href="{{ route('dashboard.profiles.index') }}" class="btn btn-secondary"><i
                    ...
                    @include('comment::inc.comment-section', [
                        'commentUrl' => route('dashboard.profiles.comment', $item->id),
                    ])
                </div>
                <!--end::Card-->
            </div>
