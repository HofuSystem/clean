        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.profiles.index")}}" data-id="{{$item->id ?? null}}"
                        @isset($item)
                            action="{{ route("dashboard.profiles.edit",$item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route("dashboard.profiles.create") }}"
                            data-mode="new"
                        @endisset
                        >
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-6">
                                <label class="" for="other_city_name">{{ trans("other city name") }}</label>
                                <input type="text" name="other_city_name" class="form-control "
                                    placeholder="{{ trans("Enter other city name") }} " value="@isset($item){{ $item->other_city_name }}@endisset">
                ...
                <textarea type="number" name="bio" class="form-control "
                    placeholder="{{ trans("Enter bio") }} " >@isset($item){{ $item->bio }}@endisset</textarea>
