        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.permissions.index")}}" data-id="{{$item->id ?? null}}"
                        @isset($item)
                            action="{{ route("dashboard.permissions.edit",$item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route("dashboard.permissions.create") }}"
                            data-mode="new"
                        @endisset
                        >
