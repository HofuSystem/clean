            ...
            <div class="card">
                        ...
                        <div data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.permissions.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.permissions.export')
                                        <a href="{{ route('dashboard.permissions.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.permissions.import')
                                        <a href="{{ route('dashboard.permissions.import') }}" class="btn-operation">
                                    ...
                                    @can('dashboard.permissions.create')
                                        <a href="{{ route('dashboard.permissions.create') }}" class="btn-operation ">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.permissions.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-center p-0" data-name="title">@lang('permission title')</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.permissions.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
