...
class DevicesExport implements FromCollection, WithHeadings, WithMapping, WithCustomCsvSettings
{
    ...
    public function headings(): array
    {
        ...
        if(empty($this->cols) or in_array('device_token',$this->cols)){
            $headings[] = trans('device token');
        }
