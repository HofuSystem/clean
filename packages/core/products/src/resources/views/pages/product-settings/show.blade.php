            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card show-page">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                ...
                                @isset($item->product)
                                    <div class="alert alert-primary m-1" role="alert"><a
                                            href="{{ route('dashboard.products.show', $item->product->id) }}">{{ $item?->product?->name ?? 'N/A' }}</a>
                                    </div>
                                @endisset
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                @isset($item->parent)
                                    <div class="alert alert-primary m-1" role="alert"><a
                                            href="{{ route('dashboard.product-settings.show', $item->parent->id) }}">{{ $item?->parent?->name ?? 'N/A' }}</a>
                                    </div>
                                @endisset
                            ...
                            <div class="mt-3">
                                <h3 class="text-dark">{{ trans('product settings') }}</h3>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        <thead class="table-primary">
                                            <tr>
                        ...
                        <div class="card-footer">
                            <a href="{{ route('dashboard.product-settings.index') }}" class="btn btn-secondary"><i
                    ...
                    @include('comment::inc.comment-section', [
                        'commentUrl' => route('dashboard.product-settings.comment', $item->id),
                    ])
                </div>
                <!--end::Card-->
            </div>
