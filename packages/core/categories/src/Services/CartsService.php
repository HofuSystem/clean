...
use Core\Categories\Models\Cart;
use Core\Categories\DataResources\CartsResource;
...
class CartsService
{
    ...
    public function storeOrUpdate(array $data = [],$id = null){
        ...
        $record     = Cart::updateOrCreate(['id' => $id],$recordData);
    ...
    public function dataTable($draw){
        ...
        $records            = Cart::select(['id','user_id','phone'])
        ->with(['user'])
