...
class CategoriesRequest extends FormRequest
{
    ...
    public function rules()
    {
      return [ 
			 ...
			 "sub_categories.*.discount_percent"                                              =>  ['nullable','numeric'], 
			 ...
			 "sub_categories.*.category_settings.*.discount_percent"                          =>  ['nullable','numeric'], 
			 ...
			 "sub_categories.*.category_settings.*.category_settings.*.discount_percent"      =>  ['nullable','numeric'], 
			 ...
			 "category_settings.*.category_settings.*.discount_percent"                       =>  ['nullable','numeric'], 
