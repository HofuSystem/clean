            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.prices.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.prices.export')
                                        <a href="{{ route('dashboard.prices.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.prices.import')
                                        <a href="{{ route('dashboard.prices.import') }}"
                                            class="btn-operation">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="priceable_type"> @lang("priceable") </label>
                                            <input type="text" name="priceable_type" class="form-control filter-input"
                                                placeholder="@lang("search for priceable") " value="{{ request("priceable_type") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label for="priceable_id"> @lang("priceable id") </label>
                                            <input type="number" name="priceable_id" class="form-control filter-input"
                                                placeholder="@lang("search for priceable id") " value="{{ request("priceable_id") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.prices.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="priceable_type">@lang("priceable")</th>
                                    <th class="text-center p-0" data-name="priceable_id">@lang("priceable id")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.prices.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
