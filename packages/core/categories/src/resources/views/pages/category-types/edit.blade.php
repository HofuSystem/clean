        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.category-types.index")}}" data-id="{{ $item->id ?? null }}"
                        @isset($item)
                            action="{{ route('dashboard.category-types.edit', $item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route('dashboard.category-types.create') }}"
                            data-mode="new"
                        @endisset>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label class="required" for="hour_price">{{ trans('hour price') }}</label>
                                <input type="number" name="hour_price" class="form-control "
                                    placeholder="{{ trans('Enter hour price') }} "
                                    value="{{ old('hour_price', $item->hour_price ?? null) }}">
