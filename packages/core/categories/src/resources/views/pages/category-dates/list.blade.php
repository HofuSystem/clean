                ...
                <div class="card">
                        ...
                        <div class="card-toolbar m-0 col-md-6">
                            ...
                            <div class="w-100" data-kt-user-table-toolbar="base">
                                ...
                                <div class="row">
                                    ...
                                    @can('dashboard.category-dates.export')
                                        <a href="{{ route('dashboard.category-dates.export') }}" id="export" type="button"
                                             class="btn btn-light-primary col-4">
                                            <i class="fas fa-upload"></i>
                                            @lang('Export Report') 
                                        </a>
                                    @endcan
                                    @can('dashboard.category-dates.import')
                                    <a href="{{ route('dashboard.category-dates.import') }}"
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.category-dates.create')
                                        <a href="{{ route('dashboard.category-dates.create') }}"
                    ...
                    <div class="container-fluid mt-5">
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link  type-switch active" id="pills-type-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-type" type="button" role="tab"
                                    aria-controls="pills-type" aria-selected="true">{{ trans('All') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button data-type="clothes" class="nav-link  type-switch" id="pills-clothes-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-clothes" type="button" role="tab"
                                    aria-controls="pills-clothes" aria-selected="true">{{ trans('clothes') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button data-type="sales" class="nav-link  type-switch" id="pills-sales-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-sales" type="button" role="tab"
                                    aria-controls="pills-sales" aria-selected="true">{{ trans('sales') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button data-type="services" class="nav-link  type-switch" id="pills-services-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-services" type="button" role="tab"
                                    aria-controls="pills-services" aria-selected="true">{{ trans('services') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button data-type="maid" class="nav-link  type-switch" id="pills-maid-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-maid" type="button" role="tab"
                                    aria-controls="pills-maid" aria-selected="true">{{ trans('maid') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button data-type="host" class="nav-link  type-switch" id="pills-host-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-host" type="button" role="tab"
                                    aria-controls="pills-host" aria-selected="true">{{ trans('host') }}</button>
                            </li>
                    ...
                    <div class="card-body pt-0 table-responsive">
                        ...
                        <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                            data-load="{{ route('dashboard.category-dates.index',['trash' => request()->trash]) }}">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-2" data-name="type">@lang("type")</th>
                                    <th class="text-center p-2" data-name="category_id">@lang("category")</th>
                                    <th class="text-center p-2" data-name="date">@lang("date")</th>
...
@push('js')
    <script>
        var deleteUrl = "{{ route('dashboard.category-dates.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
    </script>
