        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.category-dates.index")}}" data-id="{{$item->id ?? null}}"
                        @isset($item)
                            action="{{ route("dashboard.category-dates.edit",$item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route("dashboard.category-dates.create") }}"
                            data-mode="new"
                        @endisset
                        >
