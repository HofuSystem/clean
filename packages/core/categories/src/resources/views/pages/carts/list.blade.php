                    ...
                    <div class="card-header border-0 pt-6 row">
                        ...
                        <div class="card-toolbar m-0 col-md-6">
                            ...
                            <div class="d-flex justify-content-end  w-100" data-kt-user-table-toolbar="base">
                                ...
                                <!--begin::Add {{ $title }}-->
                                <a href="{{ route('dashboard.carts.create') }}" class="btn btn-primary me-3 align-middle">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select"
                                                ...
                                                @foreach ($users as $item)
                                                    <option value="{{ $item->id }}" @selected($item->value == request('user_id'))>
                        ...
                        <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-2" data-name="phone">@lang('phone')</th>
...
@push('js')
    <script>
        var deleteUrl = "{{ route('dashboard.carts.delete', '%s') }}"
    </script>
