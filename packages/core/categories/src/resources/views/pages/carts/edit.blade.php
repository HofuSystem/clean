        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.carts.index")}}" data-id="{{ $item->id ?? null }}"
                        @isset($item)
                            action="{{ route('dashboard.carts.edit', $item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route('dashboard.carts.create') }}"
                            data-mode="new"
                        @endisset>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                ...
                                <textarea type="number" name="data" class="form-control " placeholder="{{ trans('Enter data') }} ">
@isset($item)
{{ $item->data }}
@endisset
</textarea>
