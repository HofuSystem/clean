    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card">
                ...
                <form class="form" method="POST" id="operation-form" redirect-to="{{route("dashboard.category-settings.index")}}" data-id="{{ $item->id ?? null }}" @isset($item)
                    action="{{ route('dashboard.category-settings.edit', $item->id) }}" data-mode="edit" @else
                    action="{{ route('dashboard.category-settings.create') }}" data-mode="new" @endisset>
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group mb-3 col-md-12">
                            ...
                            <select class="custom-select  form-select advance-select" name="category_id"
                                ...
                                <option data-id="{{ $sItem->id }}" @selected(isset($item) and $item->category_id ==
                                    $sItem->id)
                        ...
                        <div class="form-group mb-3 col-md-12">
                            <div class="mt-3 items-container" data-items-on="parent_id"
                                data-items-name="category_settings" data-items-from="category-settings">
