                                ...
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.category-settings.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.category-settings.index',['trash' => 1]) }}">
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.category-settings.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
