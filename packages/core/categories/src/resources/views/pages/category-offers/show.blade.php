    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="col-12 mt-5">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="desc-en-tab" data-bs-toggle="tab" data-bs-target="#desc-en" type="button" role="tab" aria-controls="desc-en" aria-selected="true">
                        {{ trans("English") }}
                    </button>
                </li>
            
                <li class="nav-item" role="presentation">
                    <button class="nav-link " id="desc-ar-tab" data-bs-toggle="tab" data-bs-target="#desc-ar" type="button" role="tab" aria-controls="desc-ar" aria-selected="false">
                        {{ trans("العربية") }}
                    </button>
                </li>
            ...
            <div class="form-group mb-3 col-md-12">
                <label>{{ trans("desc") }}</label><p>{{ $item?->translate('en')?->desc ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-12">
                <label>{{ trans("desc") }}</label><p>{{ $item?->translate('ar')?->desc ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-6">
                <label>{{ trans("sale price") }}</label><p>{{ $item->sale_price ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-6">
                <label>{{ trans("hours num") }}</label><p>{{ $item->hours_num ?? 'N/A' }}</p>
            </div>
        
            <div class="form-group mb-3 col-md-6">
                <label>{{ trans("workers num") }}</label><p>{{ $item->workers_num ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-6">
                ...
                <div class="card-footer">
                    <a href="{{ route('dashboard.category-offers.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> {{ trans('Back') }}</a>
                </div>
            </div>
        

                    @include('comment::inc.comment-section',['commentUrl'=>route('dashboard.category-offers.comment',$item->id)])
                </div>
                <!--end::Card-->
            </div>
            <!--end::Container-->
