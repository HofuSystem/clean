            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.sliders.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.sliders.export')
                                        <a href="{{ route('dashboard.sliders.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.sliders.import')
                                        <a href="{{ route('dashboard.sliders.import') }}"
                                            class="btn-operation">
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="type" id="type">
                                                <option value=""> @lang("select type")</option><option value="services" @selected("services" == request("type")) >{{trans("services")}}</option><option value="sales" @selected("sales" == request("type")) >{{trans("sales")}}</option><option value="clothes" @selected("clothes" == request("type")) >{{trans("clothes")}}</option><option value="host" @selected("host" == request("type")) >{{trans("host")}}</option><option value="maid" @selected("maid" == request("type")) >{{trans("maid")}}</option>
                                            </select>
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.sliders.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="link">@lang("link")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.sliders.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
