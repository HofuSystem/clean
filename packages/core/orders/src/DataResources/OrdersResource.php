...
class OrdersResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $data =  [
            ...
            "branch_id"           => DashboardDataTableFormatter::text($this->branch?->name),
            "b2b_type"            => DashboardDataTableFormatter::text($this->b2b_type),
            ...
            "total_cost"         => DashboardDataTableFormatter::text($this->total_cost),
            ...
            "lab_cost"            => DashboardDataTableFormatter::text($this->lab_cost),
            "washer_cost"         => DashboardDataTableFormatter::text($this->washer_cost),
