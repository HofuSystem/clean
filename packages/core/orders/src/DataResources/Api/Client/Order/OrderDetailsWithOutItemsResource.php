...
class OrderDetailsWithOutItemsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'building_image'            => \Core\MediaCenter\Helpers\MediaCenterHelper::getImagesUrl($this->address?->image ?? $delivery?->address?->image ?? $receiver?->address?->image ?? $technical?->address?->image),
