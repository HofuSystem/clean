...
class ReportReasonsExport implements FromCollection, WithHeadings, WithMapping, WithCustomCsvSettings
{
    ...
    public function headings(): array
    {
        ...
        if(empty($this->cols) or in_array('ordering',$this->cols)){
            $headings[] = trans('ordering');
        }             
        return $headings;
    }
