...
class OrderTypesOfDatasExport implements FromCollection, WithHeadings, WithMapping, WithCustomCsvSettings
{
    ...
    public function headings(): array
    {
        ...
        if(empty($this->cols) or in_array('key',$this->cols)){
            $headings[] = trans('key');
        }
