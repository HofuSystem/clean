                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    @if (isset($receiver))
                                                        ...
                                                        @else
                                                            <p class="bg-warning text-dark p-1 rounded-pill text-center"> {{ trans('receiver')." : " .$receiver->representative?->fullname }}</p>
                                                        @endif
                                                    @endif
                                                    @if (isset($delivery))
                                                        ...
                                                        @else
                                                            <p class="bg-warning text-dark p-1 rounded-pill text-center"> {{ trans('delivery')." : " .$delivery->representative?->fullname }}</p>
                                                        @endif
                                                    @endif
