            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-item-qty-updates.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-item-qty-updates.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.order-item-qty-updates.export')
                                        <a href="{{ route('dashboard.order-item-qty-updates.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.order-item-qty-updates.import')
                                        <a href="{{ route('dashboard.order-item-qty-updates.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.order-item-qty-updates.create')
                                        <a href="{{ route('dashboard.order-item-qty-updates.create') }}"
                                            class="btn-operation ">
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="item_id" id="item_id">
                                                ...
                                                <option  value="" > @lang("select items")</option>
                                                @foreach($items as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("item_id")) >@lang($item->product_id)</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="number" name="from" class="form-control filter-input"
                                                placeholder="@lang("search for from") " value="{{ request("from") }}">
                                        </div>
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="to"> @lang("to") </label>
                                            <input type="number" name="to" class="form-control filter-input"
                                                placeholder="@lang("search for to") " value="{{ request("to") }}">
                                        </div>
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="updater_email"> @lang("updater email") </label>
                                            <input type="email" name="updater_email" class="form-control filter-input"
                                                placeholder="@lang("search for updater email") " value="{{ request("updater_email") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.order-item-qty-updates.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="item_id">@lang("item")</th>
                                    <th class="text-center p-0" data-name="from">@lang("from")</th>
                                    <th class="text-center p-0" data-name="to">@lang("to")</th>
                                    <th class="text-center p-0" data-name="updater_email">@lang("updater email")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.order-item-qty-updates.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
