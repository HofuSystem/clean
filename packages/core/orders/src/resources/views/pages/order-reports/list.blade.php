            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-reports.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-reports.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.order-reports.export')
                                        <a href="{{ route('dashboard.order-reports.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.order-reports.import')
                                        <a href="{{ route('dashboard.order-reports.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.order-reports.create')
                                        <a href="{{ route('dashboard.order-reports.create') }}"
                                            class="btn-operation ">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            <label for="report_reason_id">@lang("report reason")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="report_reason_id" id="report_reason_id">
                                                
                                                <option  value="" > @lang("select reportReasons")</option>
                                                @foreach($reportReasons as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("report_reason_id")) >@lang($item->name)</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 mb-1">
                                        <label for="desc_location"> @lang("desc location") </label>
                                        <input type="number" name="desc_location" class="form-control filter-input"
                                            placeholder="@lang("search for desc location") " value="{{ request("desc_location") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.order-reports.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="report_reason_id">@lang("report reason")</th>
                                    <th class="text-center p-0" data-name="desc_location">@lang("desc location")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.order-reports.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
