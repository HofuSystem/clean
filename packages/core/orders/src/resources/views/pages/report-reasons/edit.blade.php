        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form"  redirect-to="{{route("dashboard.report-reasons.index")}}" data-id="{{$item->id ?? null}}"
                        @isset($item)
                            action="{{ route("dashboard.report-reasons.edit",$item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route("dashboard.report-reasons.create") }}"
                            data-mode="new"
                        @endisset
                        >
                        ...
                        <div class="col-12 mt-5">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label class="required" for="desc">{{ trans("desc") }}</label>
                ...
                <textarea type="number" name="translations[ar][desc]" class="form-control "
                    placeholder="{{ trans("Enter desc") }} " >@isset($item) {{ $item?->translate('ar')?->desc }} @endisset</textarea>
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label class="" for="ordering">{{ trans("ordering") }}</label>
                                <input type="number" name="ordering" class="form-control "
                                    placeholder="{{ trans("Enter ordering") }} " value="{{ old("ordering" , $item->ordering ?? null) }}">
