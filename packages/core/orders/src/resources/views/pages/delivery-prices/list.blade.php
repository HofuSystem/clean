            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.delivery-prices.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.delivery-prices.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.delivery-prices.export')
                                        <a href="{{ route('dashboard.delivery-prices.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.delivery-prices.import')
                                        <a href="{{ route('dashboard.delivery-prices.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.delivery-prices.create')
                                        <a href="{{ route('dashboard.delivery-prices.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="city" id="city">
                                                
                                                <option  value="" > @lang("select cities")</option>
                                                @foreach($cities as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("city")) >@lang($item->name)</option>
                                                @endforeach
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.delivery-prices.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="free_delivery">@lang("free delivery")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.delivery-prices.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
