                ...
                <div class="card show-page">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label>{{ trans('free delivery') }}</label>
                                <p>{{ $item->free_delivery ?? 'N/A' }}</p>
                            </div>

                        </div>
                        <div class="card-footer">
                            <a href="{{ route('dashboard.delivery-prices.index') }}" class="btn btn-secondary"><i
                    ...
                    @include('comment::inc.comment-section', [
                        'commentUrl' => route('dashboard.delivery-prices.comment', $item->id),
                    ])
                </div>
                <!--end::Card-->
            </div>
