            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-items.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.order-items.export')
                                        <a href="{{ route('dashboard.order-items.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.order-items.import')
                                        <a href="{{ route('dashboard.order-items.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.order-items.create')
                                        <a href="{{ route('dashboard.order-items.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="number" name="product_price" class="form-control filter-input"
                                                placeholder="@lang("search for product price") " value="{{ request("product_price") }}">
                                        </div>
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="quantity"> @lang("quantity") </label>
                                            <input type="number" name="quantity" class="form-control filter-input"
                                                placeholder="@lang("search for quantity") " value="{{ request("quantity") }}">
                                        </div>
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="carpet_size"> @lang("carpet size") </label>
                                            <input type="number" name="carpet_size" class="form-control filter-input"
                                                placeholder="@lang("search for carpet size") " value="{{ request("carpet_size") }}">
                                        </div>
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="add_by_admin"> @lang("add by admin") </label>
                                            <input type="email" name="add_by_admin" class="form-control filter-input"
                                                placeholder="@lang("search for add by admin") " value="{{ request("add_by_admin") }}">
                                        </div>
                                        
                                        <div class="col-md-6 mb-1">
                                            <label for="update_by_admin"> @lang("update by admin") </label>
                                            <input type="email" name="update_by_admin" class="form-control filter-input"
                                                placeholder="@lang("search for update by admin") " value="{{ request("update_by_admin") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.order-items.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="product_price">@lang("product price")</th>
                                    <th class="text-center p-0" data-name="quantity">@lang("quantity")</th>
                                    <th class="text-center p-0" data-name="carpet_size">@lang("carpet size")</th>
                                    <th class="text-center p-0" data-name="add_by_admin">@lang("add by admin")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.order-items.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
