            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-types-of-datas.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.order-types-of-datas.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.order-types-of-datas.export')
                                        <a href="{{ route('dashboard.order-types-of-datas.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.order-types-of-datas.import')
                                        <a href="{{ route('dashboard.order-types-of-datas.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.order-types-of-datas.create')
                                        <a href="{{ route('dashboard.order-types-of-datas.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="text" name="key" class="form-control filter-input"
                                                placeholder="@lang("search for key") " value="{{ request("key") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                        <label for="value"> @lang("value") </label>
                                        <input type="number" name="value" class="form-control filter-input"
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.order-types-of-datas.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="key">@lang("key")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.order-types-of-datas.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
