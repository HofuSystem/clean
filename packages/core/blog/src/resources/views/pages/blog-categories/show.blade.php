    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="form-group mb-3 col-md-12">
                ...
                @isset($item->parent)
                    <div class="alert alert-primary m-1" role="alert"><a href="{{ route('dashboard.blog-categories.show',$item->parent->id) }}">{{ $item?->parent?->title ?? 'N/A' }}</a></div>
                @endisset
            ...
            <div class="form-group mb-3 col-md-12">
                ...
                <div class="card-footer">
                    <a href="{{ route('dashboard.blog-categories.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> {{ trans('Back') }}</a>
                </div>
            </div>
        

                    @include('comment::inc.comment-section',['commentUrl'=>route('dashboard.blog-categories.comment',$item->id)])
                </div>
                <!--end::Card-->
            </div>
            <!--end::Container-->
