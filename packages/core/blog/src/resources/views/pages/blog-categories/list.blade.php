            ...
            <div class="card">
                        ...
                        <div data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.blog-categories.index', ['trash' => 1]) }}">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.blog-categories.export')
                                        <a href="{{ route('dashboard.blog-categories.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.blog-categories.import')
                                        <a href="{{ route('dashboard.blog-categories.import') }}" class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.blog-categories.create')
                                        <a href="{{ route('dashboard.blog-categories.create') }}" class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <select class="custom-select filter-input form-select advance-select"
                                            ...
                                            @foreach ($parents as $item)
                                                <option value="{{ $item->id }}" @selected($item->id == request('parent_id'))>
                                                    @lang($item->title)</option>
                                            @endforeach
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <select class="custom-select filter-input form-select advance-select" name="status"
                                            id="status">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.blog-categories.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
    <script>
        var deleteUrl = "{{ route('dashboard.blog-categories.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
    </script>
@endpush
