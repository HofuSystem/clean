            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                     <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.blogs.index',['trash' => 1]) }}"> 
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    @can('dashboard.blogs.export')
                                        <a href="{{ route('dashboard.blogs.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.blogs.import')
                                        <a href="{{ route('dashboard.blogs.import') }}"
                                            class="btn-operation">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select class="custom-select filter-input form-select advance-select" name="category_id" id="category_id">
                                                ...
                                                @foreach($categories as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("category_id")) >@lang($item->title)</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 mb-1">
                                        <label for="published_at"> @lang("published_at from") </label>
                                        <input type="datetime-local" name="from_published_at" class="form-control filter-input"
                                            placeholder="@lang("search for published_at") " value="{{ request("published_at") }}">
                                            </div>
                                            <div class="col-md-6 mb-1">
                                            <label for="published_at"> @lang("published_at to") </label>
                                            <input type="datetime-local" name="to_published_at" class="form-control filter-input"
                                                placeholder="@lang("search for published_at") " value="{{ request("published_at") }}">
                                        </div>
                                        <div class="col-md-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.blogs.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="gallery">@lang("gallary")</th>
                                    <th class="text-center p-0" data-name="content">@lang("content")</th>
                                    <th class="text-center p-0" data-name="category_id">@lang("category")</th>
                                    <th class="text-center p-0" data-name="status">@lang("status")</th>
                                    <th class="text-center p-0" data-name="published_at">@lang("published_at")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.blogs.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
