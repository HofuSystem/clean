                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" id="searchInput"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search entities')" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <!--begin::cols-->
                                <div class="form-group w-300px w-md-325px mx-5 d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click"
                                    ...
                                    <!--end::Svg Icon-->@lang('Filter')
                                </button>
                                <!--begin::Menu 1-->
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                        <div class="fs-5 text-dark fw-bolder">@lang('Filter Options')</div>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Separator-->
                                ...
                                <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                                    ...
                                    <!--end::Svg Icon-->@lang('Export')
                                </button>
                                <!--end::Export-->
                                <!--begin::Add user-->
                                <a href="{{ route('dashboard.entities.create') }}"
                    ...
                    <div class="card-body pt-0 table-responsive">
                        ...
                        <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                            data-load="{{ route('dashboard.entities.dataTable') }}">
                            <!--begin::Table head-->
                            <thead class="table-primary">
                                ...
                                <th class="text-center p-2" data-name="id">@lang("id")</th>
                                    ...
                                    <th class="text-center p-2" data-name="slug">@lang("slug")</th>
                                    <th class="text-center p-2" data-name="name">@lang("name")</th>
                                    <th class="text-center p-2" data-name="table">@lang("table")</th>
                                    <th class="text-center p-2" data-name="package">@lang("package")</th>
