...
class FeaturesExport implements FromCollection, WithHeadings, WithMapping, WithCustomCsvSettings
{
    ...
    public function headings(): array
    {
        ...
        if(empty($this->cols) or in_array('section',$this->cols)){
            $headings[] = trans('section');
        }
