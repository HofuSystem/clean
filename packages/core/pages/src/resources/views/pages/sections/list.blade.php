            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.sections.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.sections.export')
                                        <a href="{{ route('dashboard.sections.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.sections.import')
                                        <a href="{{ route('dashboard.sections.import') }}"
                                            class="btn-operation">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            <label for="small_title"> @lang("small title") </label>
                                            <input type="text" name="small_title" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("small title")" value="{{ request("small_title") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="video"> @lang("video") </label>
                                            <input type="text" name="video" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("video")" value="{{ request("video") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="template">@lang("template")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="template" id="template">
                                                <option value=""> @lang("select template")</option>
                                            </select>
                                        </div>
                                    
                                        <div class="col-6 mb-1">
                                            <label for="page_id">@lang("page")</label>
                                            <select class="custom-select filter-input form-select advance-select" name="page_id" id="page_id">
                                                
                                                <option  value="" > @lang("select pages")</option>
                                                @foreach($pages as $item)
                                                    <option value="{{$item->id }}" @selected($item->id  == request("page_id")) >@lang($item->title)</option>
                                                @endforeach
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="number" name="order" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("order")" value="{{ request("order") }}">
                                        </div>
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.sections.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="small_title">@lang("small title")</th>
                                    <th class="text-center p-0" data-name="description">@lang("description")</th>
                                    <th class="text-center p-0" data-name="images">@lang("images")</th>
                                    <th class="text-center p-0" data-name="video">@lang("video")</th>
                                    <th class="text-center p-0" data-name="template">@lang("template")</th>
                                    <th class="text-center p-0" data-name="page_id">@lang("page")</th>
                                    <th class="text-center p-0" data-name="order">@lang("order")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.sections.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
