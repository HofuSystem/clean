            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.features.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.features.export')
                                        <a href="{{ route('dashboard.features.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.features.import')
                                        <a href="{{ route('dashboard.features.import') }}"
                                            class="btn-operation">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <select name="section" class="form-control filter-input">
                                                <option value="">@lang("All")</option>
                                                <option value="b2c" {{ request("section") == 'b2c' ? 'selected' : '' }}>@lang("B2C (Business to Consumer)")</option>
                                                <option value="b2b" {{ request("section") == 'b2b' ? 'selected' : '' }}>@lang("B2B (Business to Business)")</option>
                                                <option value="services" {{ request("section") == 'services' ? 'selected' : '' }}>@lang("Services")</option>
                                            </select>
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.features.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="section">@lang("section")</th>
                                    <th class="text-center p-0" data-name="is_active">@lang("is active")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.features.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
