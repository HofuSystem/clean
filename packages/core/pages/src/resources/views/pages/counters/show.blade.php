...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="form-group mb-3 col-md-6">
                <label>{{ trans("count") }}</label><p>{{ $item->count ?? 'N/A' }}</p>
            </div>
            ...
            <div class="form-group mb-3 col-md-12">
                ...
                <div class="card-footer">
                    <a href="{{ route('dashboard.counters.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> {{ trans('Back') }}</a>
                </div>
            </div>
                    ...
                    @include('comment::inc.comment-section', [
                        'commentUrl' => route('dashboard.counters.comment', $item->id),
                    ])
                </div>
                <!--end::Card-->
            </div>
