            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form" data-id="{{ $item->id ?? null }}"
                        @if (isset($item)) action="{{ route('dashboard.counters.edit', $item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route('dashboard.counters.create') }}"
                            data-mode="new" @endif>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group mb-3 col-md-12">
                                <label class="required" for="count">{{ trans('count') }}</label>
                                <input type="text" name="count" class="form-control "
                                    placeholder="{{ trans('Enter count') }} "
