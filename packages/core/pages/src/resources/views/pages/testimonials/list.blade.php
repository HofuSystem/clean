            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.testimonials.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.testimonials.export')
                                        <a href="{{ route('dashboard.testimonials.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.testimonials.import')
                                        <a href="{{ route('dashboard.testimonials.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.testimonials.create')
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="text" name="location" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("location")" value="{{ request("location") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="rating"> @lang("rating") </label>
                                            <select name="rating" class="form-control filter-input">
                                                <option value="">@lang("all")</option>
                                                @for($i = 1; $i <= 5; $i++)
                                                    <option value="{{ $i }}" {{ request("rating") == $i ? 'selected' : '' }}>{{ $i }} @lang('stars')</option>
                                                @endfor
                                            </select>
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.testimonials.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="avatar">@lang("avatar")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.testimonials.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
