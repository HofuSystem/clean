        ...
        <div class="container-fluid">
                        ...
                        <div data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.faqs.index', ['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.faqs.export')
                                        <a href="{{ route('dashboard.faqs.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.faqs.import')
                                        <a href="{{ route('dashboard.faqs.import') }}" class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.faqs.create')
                                        <a href="{{ route('dashboard.faqs.create') }}" class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                    ...
                                    <div class="col-6 mb-1">
                                        ...
                                        <input type="text" name="question" class="form-control filter-input"
                                            placeholder="@lang('search for') @lang('question')"
                                    ...
                                    <div class="col-6 mb-1">
                                        ...
                                        <input type="text" name="answer" class="form-control filter-input"
                                            placeholder="@lang('search for') @lang('answer')"
            ...
            <div class="card-body pt-0 table-responsive table-responsive">
                ...
                <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                    data-load="{{ route('dashboard.faqs.index', ['trash' => request()->trash]) }}">
                    <!--begin::Table head-->
                    <thead class="table-primary">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-center p-0" data-name="question">@lang('question')</th>
                            <th class="text-center p-0" data-name="answer">@lang('answer')</th>
...
@push('js')
    <script>
        var deleteUrl = "{{ route('dashboard.faqs.delete', ['id' => '%s', 'trash' => request()->trash]) }}"
    </script>
@endpush
