            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.comparisons.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.comparisons.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.comparisons.export')
                                        <a href="{{ route('dashboard.comparisons.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.comparisons.import')
                                        <a href="{{ route('dashboard.comparisons.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.comparisons.create')
                                        <a href="{{ route('dashboard.comparisons.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            <label for="point"> @lang("point") </label>
                                            <input type="text" name="point" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("point")" value="{{ request("point") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="us_text"> @lang("us text") </label>
                                            <input type="text" name="us_text" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("us text")" value="{{ request("us_text") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="them_text"> @lang("them text") </label>
                                            <input type="text" name="them_text" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("them text")" value="{{ request("them_text") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="is_active"> @lang("is active") </label>
                                            <select name="is_active" class="form-control filter-input">
                                                <option value="">@lang("all")</option>
                                                <option value="1" {{ request("is_active") === '1' ? 'selected' : '' }}>@lang("active")</option>
                                                <option value="0" {{ request("is_active") === '0' ? 'selected' : '' }}>@lang("inactive")</option>
                                            </select>
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.comparisons.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
                        <thead class="table-primary">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center p-0" data-name="point">@lang("point")</th>
                                    <th class="text-center p-0" data-name="us_text">@lang("us text")</th>
                                    <th class="text-center p-0" data-name="them_text">@lang("them text")</th>
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.comparisons.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
