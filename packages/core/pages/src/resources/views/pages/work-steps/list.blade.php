            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.work-steps.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.work-steps.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.work-steps.export')
                                        <a href="{{ route('dashboard.work-steps.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.work-steps.import')
                                        <a href="{{ route('dashboard.work-steps.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.work-steps.create')
                                        <a href="{{ route('dashboard.work-steps.create') }}"
                                            class="btn-operation ">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <div class="col-6 mb-1">
                                            ...
                                            <input type="text" name="description" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("description")" value="{{ request("description") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                                            <label for="icon"> @lang("icon") </label>
                                            <input type="text" name="icon" class="form-control filter-input"
                                                placeholder="@lang("search for") @lang("icon")" value="{{ request("icon") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.work-steps.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.work-steps.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
