            ...
            <div class="card">
                        ...
                        <div  data-kt-user-table-toolbar="base">
                            <div class="d-flex justify-content-between">
                                <div class="">
                                    <div class="d-flex">
                                        ...
                                        <div class="border border-dashed border-success text-success rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.contact-requests.index') }}">
                                        ...
                                        <div class="border border-dashed border-danger  text-danger rounded mx-1 p-2">
                                            <a href="{{ route('dashboard.contact-requests.index',['trash' => 1]) }}">
                                ...
                                <div class="d-flex">
                                    ...
                                    @can('dashboard.contact-requests.export')
                                        <a href="{{ route('dashboard.contact-requests.export') }}" id="export" type="button"
                                            class="btn-operation ">
                                    ...
                                    @endcan
                                    @can('dashboard.contact-requests.import')
                                        <a href="{{ route('dashboard.contact-requests.import') }}"
                                            class="btn-operation">
                                    ...
                                    @endcan
                                    <!--begin::Add -->
                                    @can('dashboard.contact-requests.create')
                                        <a href="{{ route('dashboard.contact-requests.create') }}"
                                            class="btn-operation ">
                        ...
                        <div class="accordion-item">
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="p-1 row" data-kt-user-table-filter="form">
                                        ...
                                        <input type="number" name="notes" class="form-control filter-input"
                                            placeholder=""@lang("search for") @lang("notes") " value="{{ request("notes") }}">
                                        </div>
                                        <div class="col-6 mb-1">
                ...
                <div class="card-body pt-0 table-responsive table-responsive">
                    ...
                    <table class="table align-middle text-center table-row-dashed fs-6 gy-5" id="view-datatable"
                        data-load="{{ route('dashboard.contact-requests.index',['trash' => request()->trash]) }}">
                        <!--begin::Table head-->
...
@push('js')
<script>
    var deleteUrl = "{{ route('dashboard.contact-requests.delete', ['id'=>'%s','trash'=>request()->trash]) }}"
</script>
@endpush
