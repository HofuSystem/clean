            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <form class="form" method="POST" id="operation-form" data-id="{{ $item->id ?? null }}"
                        @if (isset($item)) action="{{ route('dashboard.businesses.edit', $item->id) }}"
                            data-mode="edit"
                        @else
                            action="{{ route('dashboard.businesses.create') }}"
                            data-mode="new" @endif>
                                ...
                                <div class="tab-content mt-3" id="languageTabsContent">
                                    <div class="tab-pane fade show active" id="title-en" role="tabpanel"
                                        ...
                                        <div class="form-group mb-3 col-md-12">
                                            <label class="" for="title">{{ trans('title') }}</label>
                                ...
                                <ul class="nav nav-tabs" id="languageTabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="description-en-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="description-en" aria-selected=" true">{{ trans('English') }}</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link  " id="description-ar-tab" data-bs-toggle="tab"
                                            data-bs-target="#description-ar" type="button" role="tab"
                                            aria-controls="description-ar" aria-selected=" false">{{ trans('arabic') }}</button>
                                    </li>
                                ...
                                <div class="tab-content mt-3" id="languageTabsContent">
                                    <div class="tab-pane fade show active" id="description-en" role="tabpanel"
                                        ...
                                        <div class="form-group mb-3 col-md-12">
                                            ...
                                            <input type="text" name="translations[en][description]" class="form-control "
                                                placeholder="{{ trans('Enter description') }} "
                                                value="@if (isset($item)) {{ $item?->translate('en')?->description }} @endif">
                                    ...
                                    <div class="tab-pane fade " id="description-ar" role="tabpanel" aria-labelledby="ar-tab">
                                        ...
                                        <div class="form-group mb-3 col-md-12">
                                            <label class="" for="description">{{ trans('description') }}</label>
                                            <input type="text" name="translations[ar][description]" class="form-control "
                                                placeholder="{{ trans('Enter description') }} "
                                                value="@if (isset($item)) {{ $item?->translate('ar')?->description }} @endif">
