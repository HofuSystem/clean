        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="form-group mb-3 col-md-6">
                ...
                <div class="card-footer">
                    <a href="{{ route('dashboard.businesses.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> {{ trans('Back') }}</a>
                </div>
            </div>
                    ...
                    @include('comment::inc.comment-section', [
                        'commentUrl' => route('dashboard.businesses.comment', $item->id),
                    ])
                </div>
                <!--end::Card-->
            </div>
