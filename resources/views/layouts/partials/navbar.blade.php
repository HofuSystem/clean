<nav class="fixed w-full z-50 transition-all duration-300 bg-white/90 backdrop-blur-md border-b border-gray-100" id="navbar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden xl:flex items-center space-x-1 rtl:space-x-reverse bg-gray-50 px-2.5 py-1.5 rounded-full border border-gray-200/50">
                <a href="{{ route('home') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('home') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ trans('home') }}</a>
                <a href="{{ route('services') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('services*') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ trans('services') }}</a>
                <a href="{{ route('pricing') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('pricing') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ app()->getLocale() === 'ar' ? 'التسعير' : 'Pricing' }}</a>
                <a href="{{ route('coverage') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('coverage') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ app()->getLocale() === 'ar' ? 'التغطية' : 'Coverage' }}</a>
                <a href="{{ route('why-us') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('why-us') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ trans('why_us') }}</a>
                <a href="{{ route('b2b') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('b2b') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ trans('business') }}</a>
                <a href="{{ route('blog') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('blog*') || Route::is('blogs*') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ trans('blog') }}</a>
                <a href="{{ route('faq') }}" class="px-3 py-1.5 rounded-full text-xs font-bold {{ Route::is('faq') ? 'bg-white text-brand-600 shadow-sm' : 'text-gray-600 hover:text-brand-600' }} transition-all whitespace-nowrap">{{ trans('faq') }}</a>
            </div>
            ...
            <div class="flex items-center gap-2 md:gap-3">
                ...
                @if(Route::is('b2b'))
                    <a href="{{ route('client.login') }}" class="hidden sm:flex bg-brand-600 text-white px-4 py-2.5 rounded-xl font-bold text-xs hover:bg-brand-700 transition-all shadow-lg shadow-brand-200">
                        {{ trans('login') }}
                    </a>
                @endif
                <a href="{{ route('contact') }}" class="hidden sm:flex bg-brand-600 text-white px-4 py-2.5 rounded-xl font-bold text-xs hover:bg-brand-700 transition-all shadow-lg shadow-brand-200">
                    {{ trans('contact') }}
                </a>
